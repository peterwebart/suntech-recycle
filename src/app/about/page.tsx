...
const roles: { icon: IconName; title: string; body: string }[] = [
  {
    ...
    body: "Independently audited to the leading SERI R2v3 standard for responsible electronics recycling.",
  },
  {
    icon: "refresh",
    title: "IT asset disposition partner",
    body: "A single accountable partner for the full retired-hardware lifecycle, dock to certificate.",
  },
  {
    icon: "chip",
    title: "Corporate electronics recycling partner",
  ...
  },
  {
    ...
    body: "NIST 800-88 wiping and physical destruction with a serialized certificate per asset.",
  },
  {
    icon: "layers",
    title: "E-scrap trading company",
    body: "Commodity recovery and electronics buyback that surface residual value in retired assets.",
  },
  {
    icon: "file-check",
    title: "Asset recovery specialist",
    body: "Remarketing and IT asset recovery that return value to your balance sheet with clear reporting.",
  },
];
    ...
    <>
      ...
      <section className="bg-near-black py-[clamp(40px,6vw,72px)] text-white">
        <Container>
          ...
          <div className="mt-7">
            <CertBadge variant="dark" size={56} />
          </div>
        </Container>
      </section>
