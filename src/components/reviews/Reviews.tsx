  ...
  return (
    <div>
      <div data-reveal className="max-w-[64ch]">
        ...
        <h2 className="mt-3 text-[clamp(26px,3.6vw,38px)]">
          Trusted by businesses across {cityName}
        </h2>
      </div>
      ...
      {REVIEWS_ARE_SAMPLE && (
        <p className="mt-5 rounded-lg border border-orange/30 bg-orange/[0.07] px-4 py-3 font-mono text-[11.5px] leading-relaxed tracking-[0.02em] text-ink-soft">
          Sample reviews — these are representative placeholders for layout and
          must be replaced with verified client reviews before launch.
        </p>
      )}
