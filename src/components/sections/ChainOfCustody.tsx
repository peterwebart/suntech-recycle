    ...
    <Section tone="ink" id="custody">
      <Container>
        <div data-reveal className="max-w-[64ch]">
          ...
          <h2 className="mt-3.5 text-[clamp(28px,4.4vw,44px)] text-white">
            Every asset, tracked from your dock to its certificate.
          </h2>
          <p className="mt-4 text-[18px] text-[#b9c2bb]">
            A breach during disposal is still your breach. Our custody trail
            lets you prove exactly what happened to every device — to any
            auditor, regulator or client.
          </p>
        </div>
        ...
        <ol className="relative mt-12 grid gap-y-9 md:grid-cols-4 md:gap-6">
          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              />
              <span className="font-mono text-[12px] tracking-[0.12em] text-orange">
                {s.id}
              </span>
